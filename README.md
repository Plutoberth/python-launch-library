...
## Important: New projects should NOT use this library. Instead, generate client stubs from the OpenAPI definitions provided in https://ll.thespacedevs.com/2.0.0/swagger using [openapi-generator](https://github.com/OpenAPITools/openapi-generator).
